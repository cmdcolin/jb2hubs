...
rclone sync -c -v --exclude "*.hash" --exclude "*.xxh" --exclude "*_meta.json" "$UCSC_RESULTS_DIR" jbrowse-data-hashed:jbrowse.org/ucsc --s3-storage-class INTELLIGENT_TIERING --checkers 20
