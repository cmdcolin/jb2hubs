    ...
    <div className="flex flex-col items-center">
      <div className="lg:w-1/2">
          ...
          {val ? (
            <div className="float-right ml-6 mb-4 max-w-xs">
              <figure className="m-0">
                ...
                <figcaption>
                  <StyledLink href={source} external>(source)</StyledLink>
                </figcaption>
              </figure>
            </div>
          ) : null}
        ...
        <div>
          ...
          <UL>
            <LI>
              <StyledLink href={ret.jbrowseLink} external>JBrowse </StyledLink>
            </LI>
            <LI>
              <StyledLink href={ret.igvBrowserLink} external>IGV.js</StyledLink>
            </LI>
            <LI>
              <StyledLink href={ret.ncbiBrowserLink} external>NCBI GDV</StyledLink>
            </LI>
            <LI>
              <StyledLink href={ret.ucscBrowserLink} external>UCSC</StyledLink>
            </LI>
          </UL>
        </div>
        <div>
          ...
          <UL>
            <LI>
              <StyledLink href={ret.ucscDataLink} external>UCSC hub folder</StyledLink>
            </LI>
            <LI>
              <StyledLink href={ret.ncbiLink} external>NCBI assembly page</StyledLink>
            </LI>
            <LI>
              <StyledLink
